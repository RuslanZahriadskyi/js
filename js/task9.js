...
// параметры и проверяет наличие login в массиве allLogins, возвращая true если такого логина еще нет и false если логин уже используется.
...
function isLoginValid(login, min = 4, max = 16) {
  ...
  let loginlength = login.length >= min && login.length <= max;
  return loginlength;
}
